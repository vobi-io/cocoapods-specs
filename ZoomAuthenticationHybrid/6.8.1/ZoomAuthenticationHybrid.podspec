Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cocoapods.facetec.com/zoom-authentication/ZoomAuthentication-ios-6.8.1.zip" }

  s.framework 	 = "ZoomAuthenticationHybrid"
  s.vendored_frameworks = "ZoomAuthentication-ios-6.8.1/ZoomAuthenticationHybrid.framework"
