Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cocoapods.facetec.com/zoom-authentication/ZoomAuthentication-ios-7.0.0.zip" }

  s.framework 	 = "ZoomAuthenticationHybrid"
  s.vendored_frameworks = "ZoomAuthentication-ios-7.0.0/ZoomAuthenticationHybrid.framework"
