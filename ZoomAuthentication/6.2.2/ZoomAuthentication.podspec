Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cocoapods.facetec.com/zoom-authentication/ZoomAuthentication-ios-6.2.2.zip" }

  s.framework 	 = "ZoomAuthentication"
  s.vendored_frameworks = "ZoomAuthentication-ios-6.2.2/ZoomAuthentication.framework"
