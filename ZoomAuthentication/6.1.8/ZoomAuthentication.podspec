Pod::Spec.new do |s|
  ...
  s.source       = { :http => "http://cocoapods.facetec.com/zoom-authentication/ZoomAuthentication-ios-6.1.8.zip" }

  s.framework 	 = "ZoomAuthentication"
  s.vendored_frameworks = "ZoomAuthentication-ios-6.1.8/ZoomAuthentication.framework"
